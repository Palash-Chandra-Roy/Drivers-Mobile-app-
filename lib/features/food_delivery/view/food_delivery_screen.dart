...
class _FoodDeliveryScreenState extends State<FoodDeliveryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Food Delivery'),
      body: provider.isLoading || delivery == null
          ? const AppLoader()
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomButton(
                    ...
                    onPressed: () => Navigator.pushNamed(context, RouteNames.pickupDetails),
                  ),
                  const SizedBox(height: AppSizes.paddingSm),
                  CustomButton(
                    title: 'Drop-off Details',
                    outlined: true,
                    onPressed: () => Navigator.pushNamed(context, RouteNames.dropoffDetails),
                  ),
                ],
              ),
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(address, style: const TextStyle(color: AppColors.textLight, fontSize: 13)),
                ],
              ),
            ),
          ],
